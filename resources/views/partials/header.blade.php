...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <meta name="author" content="Patrik Strišovský">
        <meta name="keywords" content="strišovský, tvorba web stránok, tvorba webových aplikácií, portfólio, web developer, php developer, html developer">
        <meta name="description" content="Osobné portfólio">
        <meta property="og:site_name" content="portfolio.strisovsky.sk">
        <meta property="og:title" content="Patrik Strišovský - web developer">
        <meta property="og:description" content="Osobné portfólio">
        <meta property="og:image" content="{{ asset('assets/images/icon/favicon-196x196.png') }}">
        <meta property="og:url" content="{{ URL::to('/') }}">
        <title>Patrik Strišovský - web developer</title>
        ...
        <meta name="application-name" content="Patrik Strišovský - web developer">
